        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "This request is being served through the configured "
                    "online remote model gateway. If the remote service "
                    "were unavailable, the separate offline fallback "
                    "model would handle the request instead and would not "
                    "receive this system message. An empty available_tools "
                    "list, zero routed tools, or default_deny permissions "
                    "means only that no tool schema was selected for this "
                    "request; it never means that the model is offline. "
                    "Never infer model runtime mode from tool availability. "
                    "You may answer general questions directly. Obey tool "
                    "policy, use tool "
